...
This repository contains our group project analyzing the relationship between PM2.5 air pollution levels and asthma prevalence and mortality across U.S. states. The project focuses on identifying trends over time, with particular attention to changes during and after the COVID-19 pandemic.
...
- Use a main branch and individual development branches for each team member  
- Make regular commits with clear, descriptive messages (each member will contribute at least 5 commits)  
- Use GitHub Issues to track tasks, responsibilities, and progress  
- Use Pull Requests to merge changes, with at least one team member reviewing and approving before merging  
- Follow a consistent coding style (Tidyverse) and use lintr to check code quality
